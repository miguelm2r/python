...
def iniciar():
    while True:
        ...
        if opcion == '1':
            ...
            apellido = helpers.leer_texto(2,30,"Nombre (de 2 a 30 chars) ").capitalize()
            ...
            if cliente:
                ...
                apellido = helpers.leer_texto(2,30,f"Nombre (de 2 a 30 chars) [{cliente.apellido}] ").capitalize()
